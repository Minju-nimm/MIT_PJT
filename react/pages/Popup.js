...
const Popup = () => {
    ...
    useEffect(() => {
        ...
        const handleButtonClick = async () => {
            ...
            try {
                // POST 요청 보내기 - 이미지 - 스토리
                const storyResponse = await axios.post('http://223.130.130.89:3500/get_story');
                ...
                const response = await axios.post('http://223.130.130.89:3500/get_data', {}, { responseType: 'arraybuffer' });
