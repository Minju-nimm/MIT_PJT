...
class MyDataset(Dataset):
    def __init__(self, root_path="/root/QuickDraw/data", total_images_per_class=2000, ratio=0.8, mode="train"):
...
if __name__ == "__main__":
    training_set = MyDataset("/root/QuickDraw/data", 500, 0.8, "train")
